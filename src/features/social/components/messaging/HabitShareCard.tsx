  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 border-b border-teal-300/15 bg-gradient-to-br from-teal-300/[0.14] to-emerald-300/[0.06] px-4 py-3">
        ...
        <span className="text-[10px] font-extrabold uppercase tracking-[0.14em] text-teal-200/90">
          Habit completed
        </span>
      </div>
      ...
      <div className="px-4 py-4">
        <div className="flex items-center gap-3">
          <div className="flex size-11 items-center justify-center rounded-2xl border border-teal-300/15 bg-teal-300/[0.08]">
            <span
      ...
      <div className="grid grid-cols-2 gap-2 border-t border-white/[0.08] px-4 py-3">
        <button
          type="button"
          className="flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-teal-300/25 bg-teal-300/[0.10] px-3 py-2 text-[12px] font-semibold text-teal-200 transition-colors hover:bg-teal-300/[0.16]"
        ...
        <button
          type="button"
          className="flex cursor-pointer items-center justify-center gap-2 rounded-xl border border-white/[0.10] bg-white/[0.03] px-3 py-2 text-[12px] font-semibold text-white/65 transition-colors hover:bg-white/[0.06] hover:text-white"
