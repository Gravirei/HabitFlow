    ...
    <div className="mt-1 flex flex-wrap gap-1.5 px-1">
      {reactions.map((r) => (
        <motion.button
          ...
          className={
            'inline-flex cursor-pointer items-center gap-1 rounded-full px-2.5 py-1 text-[13px] transition-all duration-200 ' +
            (r.hasCurrentUser
              ? 'border border-teal-300/30 bg-teal-300/[0.10] shadow-[0_10px_25px_rgba(0,229,204,0.10)]'
