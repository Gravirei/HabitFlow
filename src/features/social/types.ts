...
export type LeagueTier =
  ...
  | 'baber_gravidon'
  | 'dioga_gravidon'
  | 'diborudo_jii_gravidon'
  | 'nyuborutsu_ma_gurabirei'
  | 'nyuborutsu_shin_gurabirei'
  | 'berudo_gravirei'
  | 'bidom_gravirei'
  | 'kueaborutsu_gravirei'
  | 'digou_gurabiruku'
  | 'shin_baberuga_gravidon'
  // Zatch
  | 'zaker'
  | 'zakeruga'
  | 'teozaker'
  ...
  | 'zaguruzemu'
  | 'bao_zakeruga'
  | 'baou_kurou_disugurugu'
  | 'jiou_renzu_zakeruga'
  | 'shin_beruwan_bao_zakeruga'
  | 'barudo_forusu'
  // Tio
  | 'seoshi'
  | 'ma_seshield'
