...
export const notionService = {
  ...
  async exchangeCode(code: string): Promise<{ accessToken: string; workspaceId: string }> {
    const clientId = import.meta.env.VITE_NOTION_CLIENT_ID || 'YOUR_NOTION_CLIENT_ID'
    const clientSecret = import.meta.env.VITE_NOTION_CLIENT_SECRET || 'YOUR_NOTION_CLIENT_SECRET'
