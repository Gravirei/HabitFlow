  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: `radial-gradient(circle at 10% 10%, ${accent}20 0%, transparent 65%)`,
        }}
      />
      ...
      <p className="mt-3 text-[10px] font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
        {label}
      </p>
    </motion.div>
  )
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <div className="flex-1">
        <AnimatedBar pct={pct} color={color} delay={0.1} />
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="w-24 shrink-0">
        <AnimatedBar pct={rate} color={color} delay={0.05 + index * 0.04} />
      </div>
      <span className="w-14 shrink-0 text-right text-xs tabular-nums text-slate-500 dark:text-slate-400">
        {completed}/{total}
      </span>
      <span
        className="w-11 shrink-0 rounded-md px-1.5 py-0.5 text-center text-xs font-bold"
...
function PerformerCard({
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-sm font-bold tabular-nums" style={{ color: badgeColor }}>
          {badge}
        </span>
      </div>
    </motion.div>
...
function TabBar({
  ...
  return (
    <div
      className="flex shrink-0 border-b border-slate-200 bg-white dark:border-slate-700/60 dark:bg-slate-800/60"
      role="tablist"
    >
      {tabs.map((tab) => {
...
export function AllHabitsStatsModal({ isOpen, onClose }: AllHabitsStatsModalProps) {
  ...
  const activeHabits = habits.filter(
    (h) =>
      h.isActive && !h.archived && !h.hiddenDates?.includes(today) && h.categoryId !== undefined
  )
                ...
                <div className="flex h-full flex-col items-center justify-center gap-4 px-6 text-center">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-slate-500">
                      Add habits to start seeing your statistics here.
                    </p>
                  </div>
                </div>
              ) : (
                <AnimatePresence mode="wait" custom={direction}>
                  ...
                  >
                            ...
                            <div className="mt-3 flex gap-0.5 overflow-hidden rounded-full">
                              {activeHabits.map((h) => (
                                <motion.div
                                  ...
                                  style={{
                                    backgroundColor: isCompletedToday(h.id) ? ringColor : '#E2E8F0',
                                  }}
                                  initial={{ scaleY: 0 }}
                                  animate={{ scaleY: 1 }}
                        ...
                        <div className="rounded-2xl bg-white p-5 shadow-sm dark:bg-slate-800/70">
                          ...
                          <div className="space-y-3">
                            {[
                              ...
                              {
                                label: 'Remaining',
                                count: totalHabits - completedToday,
                                color: '#CBD5E1',
                              },
                      ...
                      <div className="space-y-4 px-5 py-5 pb-12">
                        ...
                        {(habitWithMaxStreak || bestHabit) && (
                          <div className="space-y-3">
                            ...
                            {bestHabit && (
                              <PerformerCard
                                sublabel="Most Completed"
                                name={bestHabit.name}
                                badge={`${bestHabit.completedDates?.length ?? 0}×`}
                                badgeColor={EMERALD}
                                delay={0.06}
                              />
                            )}
                                  ...
                                  <div key={h.id} className="flex items-center gap-3">
                                    ...
                                    <div className="w-24 shrink-0">
                                      <AnimatedBar
                                        pct={
                                          maxStreak > 0
                                            ? ((h.currentStreak || 0) / maxStreak) * 100
                                            : 0
                                        }
                                        color={VIOLET}
                                        delay={0.05 + i * 0.04}
                    ...
                    {activeTab === 'frequency' && (
                      <div className="space-y-4 px-5 py-5 pb-12">
                        <div className="rounded-2xl bg-white p-5 shadow-sm dark:bg-slate-800/70">
                          <p className="mb-5 text-[10px] font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">
                            Frequency Breakdown
                          </p>
                        ...
                        {dailyHabits > 0 && (
                          <div
                            className="rounded-xl border p-4 dark:border-emerald-900/30 dark:bg-emerald-900/10"
                          ...
                          >
                            ...
                            <p className="mt-1.5 text-sm leading-relaxed text-slate-600 dark:text-slate-300">
                              <span className="font-bold text-slate-800 dark:text-white">
                                {((dailyHabits / totalHabits) * 100).toFixed(0)}%
                              </span>{' '}
                              of your habits are tracked daily — great for building long-term
                              consistency.
                            </p>
                          </div>
                        )}
                          ...
                          <div className="flex h-64 flex-col items-center justify-center gap-3 text-center">
                            ...
                            <div>
                              ...
                              <p className="mt-1 text-xs text-slate-400 dark:text-slate-500">
                                Add habits to categories to see a breakdown here.
                              </p>
                            </div>
                          </div>
                        ) : (
                              ...
                              (() => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    <div
                                      className="pointer-events-none absolute -right-6 -top-6 size-44 rounded-full opacity-20 blur-3xl transition-opacity duration-500 group-hover:opacity-35"
                                      ...
                                      <div className="relative shrink-0">
                                        <svg width={72} height={72} className="-rotate-90">
                                          ...
                                          <motion.circle
                                            ...
                                            initial={{ strokeDashoffset: circ }}
                                            animate={{
                                              strokeDashoffset: circ - (s.rate / 100) * circ,
                                            }}
                                            transition={{
                                              duration: 0.9,
                                              ease: 'easeOut',
                                ...
                                {categoryStats.slice(1).map((s, i) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      {/* Subtle glow */}
                                      <div
                                        className="pointer-events-none absolute -right-4 -top-4 size-20 rounded-full opacity-40 blur-2xl transition-opacity duration-300 group-hover:opacity-60"
                                        style={{ backgroundColor: s.color }}
                                      />
