...
describe('TimerAnnouncer', () => {
  ...
  describe('Different Message Types', () => {
    it('should announce timer start', () => {
      const { container } = render(
        <TimerAnnouncer message="Countdown timer started for 5 minutes" />
      )
    ...
    it('should announce timer pause', () => {
      const { container } = render(
        <TimerAnnouncer message="Stopwatch paused at 2 minutes 30 seconds" />
      )
    ...
    it('should announce interval transitions', () => {
      const { container } = render(
        <TimerAnnouncer message="Work complete. Break time: 5 minutes" />
      )
  ...
  describe('Edge Cases', () => {
    it('should handle very long messages', () => {
      const longMessage =
        'This is a very long announcement that contains a lot of information about the timer state including the time remaining and the current interval and the loop number and the session name and all sorts of other details that might be useful to the user'
