...
describe('TimerDisplay', () => {
  describe('Rendering', () => {
    it('should render time display', () => {
      render(<TimerDisplay timeLeft={60000} progress={100} mode="Stopwatch" />)
    ...
    it('should format time correctly for different durations', () => {
      const { rerender } = render(
        <TimerDisplay timeLeft={3661000} progress={100} mode="Countdown" />
      )

      expect(screen.getByText('1:01:01')).toBeInTheDocument()

      rerender(<TimerDisplay timeLeft={59000} progress={100} mode="Countdown" />)
    ...
    it('should display zero time', () => {
      render(<TimerDisplay timeLeft={0} progress={0} mode="Stopwatch" />)
  ...
  describe('Progress Circle', () => {
    it('should render SVG circle elements', () => {
      const { container } = render(<TimerDisplay timeLeft={30000} progress={50} mode="Countdown" />)
    ...
    it('should calculate stroke-dashoffset based on progress', () => {
      const { container } = render(
        <TimerDisplay timeLeft={30000} progress={150} mode="Countdown" />
      )
    ...
    it('should handle 0% progress', () => {
      const { container } = render(<TimerDisplay timeLeft={0} progress={0} mode="Countdown" />)
    ...
    it('should handle 100% progress', () => {
      const { container } = render(
        <TimerDisplay timeLeft={60000} progress={301.59} mode="Countdown" />
      )
  ...
  describe('Last 30 Seconds Warning', () => {
    it('should show red warning in Countdown mode when under 30 seconds', () => {
      const { container } = render(
        <TimerDisplay timeLeft={25000} progress={100} mode="Countdown" />
      )
    ...
    it('should show red warning in Intervals mode when under 30 seconds', () => {
      const { container } = render(
        <TimerDisplay timeLeft={15000} progress={100} mode="Intervals" currentInterval="work" />
      )
    ...
    it('should NOT show red warning in Stopwatch mode', () => {
      const { container } = render(
        <TimerDisplay timeLeft={15000} progress={100} mode="Stopwatch" />
      )
    ...
    it('should show red at exactly 30 seconds', () => {
      const { container: _container1 } = render(
        <TimerDisplay timeLeft={30000} progress={100} mode="Countdown" />
      )
    ...
    it('should show red at 29.9 seconds', () => {
      const { container: _container2 } = render(
        <TimerDisplay timeLeft={29900} progress={100} mode="Countdown" />
      )
    ...
    it('should not show red at exactly 0', () => {
      const { container: _container3 } = render(
        <TimerDisplay timeLeft={0} progress={0} mode="Countdown" />
      )
  ...
  describe('Time Formatting', () => {
    it('should format hours, minutes, and seconds', () => {
      render(<TimerDisplay timeLeft={3723000} progress={100} mode="Stopwatch" />)

      expect(screen.getByText('1:02:03')).toBeInTheDocument()
    })

    it('should pad single digits with zeros', () => {
      render(<TimerDisplay timeLeft={65000} progress={100} mode="Countdown" />)

      expect(screen.getByText('1:05')).toBeInTheDocument()
    })

    it('should handle milliseconds correctly', () => {
      render(<TimerDisplay timeLeft={59999} progress={100} mode="Countdown" />)
    ...
    it('should format very long durations', () => {
      render(<TimerDisplay timeLeft={359999000} progress={100} mode="Stopwatch" />)
  ...
  describe('Different Timer Modes', () => {
    it('should render in Stopwatch mode', () => {
      render(<TimerDisplay timeLeft={30000} progress={100} mode="Stopwatch" />)

      expect(screen.getByText(/0:30\.\d{2}/)).toBeInTheDocument()
    })

    it('should render in Countdown mode', () => {
      render(<TimerDisplay timeLeft={30000} progress={100} mode="Countdown" />)
    ...
    it('should render in Intervals mode', () => {
      render(
        <TimerDisplay timeLeft={30000} progress={100} mode="Intervals" currentInterval="work" />
      )
  ...
  describe('Edge Cases', () => {
    it('should handle negative time (treat as 0)', () => {
      render(<TimerDisplay timeLeft={-1000} progress={0} mode="Countdown" />)
    ...
    it('should handle very large progress values', () => {
      const { container } = render(
        <TimerDisplay timeLeft={30000} progress={10000} mode="Countdown" />
      )
    ...
    it('should handle undefined currentInterval gracefully', () => {
      render(
        <TimerDisplay timeLeft={30000} progress={100} mode="Intervals" showIntervalStatus={true} />
      )
  ...
  describe('Component Updates', () => {
    it('should update when timeLeft changes', () => {
      const { rerender } = render(<TimerDisplay timeLeft={60000} progress={100} mode="Stopwatch" />)

      expect(screen.getByText('1:00')).toBeInTheDocument()

      rerender(<TimerDisplay timeLeft={45000} progress={75} mode="Stopwatch" />)
