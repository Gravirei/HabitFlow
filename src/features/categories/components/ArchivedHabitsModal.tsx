      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative flex max-h-[80vh] w-full max-w-2xl flex-col rounded-3xl bg-white shadow-2xl dark:bg-slate-900"
          >
            {/* Header */}
  ...
  return (
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        <h4 className="truncate font-semibold text-slate-900 dark:text-white">{habit.name}</h4>
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Archived{' '}
          {habit.archivedDate ? new Date(habit.archivedDate).toLocaleDateString() : 'recently'}
        </p>
      </div>
