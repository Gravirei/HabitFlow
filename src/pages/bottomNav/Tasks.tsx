...
import { HybridKanban } from '@/features/tasks/components/kanban/HybridKanban'
import { TrelloKanban } from '@/features/tasks/components/kanban/TrelloKanban'
import { MinimalKanban } from '@/features/tasks/components/kanban/MinimalKanban'
import { NotionKanban } from '@/features/tasks/components/kanban/NotionKanban'
import { AsanaKanban } from '@/features/tasks/components/kanban/AsanaKanban'
import { TaskCardWithMenu } from '@/features/tasks/components/TaskCardWithMenu'
import { QuickActionsMenu } from '@/features/tasks/components/QuickActionsMenu'
import { TemplateCreationModal } from '@/features/tasks/components/TemplateCreationModal'
...
export function Tasks() {
  ...
  return (
    <div className="relative mx-auto flex h-auto min-h-screen w-full max-w-md flex-col overflow-x-hidden bg-gray-50 dark:bg-gray-950 sm:max-w-2xl md:max-w-4xl lg:max-w-6xl xl:max-w-7xl">
      ...
      <header className="pt-safe fixed left-0 right-0 top-0 z-30 mx-auto max-w-md bg-background-light/80 p-4 pb-2 backdrop-blur-xl transition-all dark:bg-background-dark/80 sm:max-w-2xl sm:rounded-none md:max-w-4xl lg:max-w-6xl xl:max-w-7xl">
