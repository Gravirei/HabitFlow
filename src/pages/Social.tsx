...
import { SocialHub } from '@/features/social'
import { SocialBottomNav, type SocialTab } from '@/features/social'
import { useSocialStore } from '@/features/social/store/socialStore'
import { getLevelForXP } from '@/features/social/constants'
  ...
  return (
    ...
    >
      <main className="relative flex-grow pb-32 pt-20">
        ...
        >
          <div className="pt-safe flex items-center justify-between px-4 pb-3 sm:px-6 lg:px-8">
            {/* Back + Menu */}
