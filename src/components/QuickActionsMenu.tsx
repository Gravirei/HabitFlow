    ...
    >
      ...
      {template.isCustom && onQuickAdd && (
        ...
        >
          ...
          {/* Icon */}
          <span className="material-symbols-outlined text-white text-[28px] font-light relative z-10 group-hover/quickadd:rotate-90 transition-transform duration-300">add</span>
        </button>
      )}
  ...
  return (
    ...
    >
      ...
      <div className={`absolute inset-0 z-[60] flex items-end justify-end overflow-hidden transition-all duration-500 ${showSettingsSidebar ? 'pointer-events-auto' : 'pointer-events-none'}`}>
        ...
        {/* Sidebar */}
        <div
          className={`relative w-80 h-full bg-gray-50/80 dark:bg-white/5 backdrop-blur-xl border-l border-gray-200/50 dark:border-white/5 shadow-2xl flex flex-col transition-transform duration-500 ease-in-out rounded-r-[2.5rem] ${
