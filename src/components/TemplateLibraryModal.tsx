...
export const DEFAULT_TEMPLATES: TaskTemplate[] = [
  ...
  },
  {
    ...
    name: 'Create Social Post: [Platform]',
  ...
  },
  {
    ...
    name: 'Prepare: [Presentation Topic]',
  ...
  // Learning & Development Category
  {
    ...
    name: 'Course: [Course Name] - Module X',
  ...
  },
  {
    ...
    name: 'Learn [Language] - Daily Practice',
  ...
  },
  {
    ...
    name: 'Study for [Certification Name]',
